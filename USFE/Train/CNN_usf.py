...
class SimpleCNN(nn.Module):
    def __init__(self):
        ...
        self.linear1 = nn.Linear(880, 1024)
...
# In[6]
input_size, hidden_size, num_layers, num_classes = 8, 32, 3, 5

model = SimpleCNN()
# model = RnnNet(input_size, hidden_size, num_layers, num_classes)
model.to(device)
...
y_train = y_train / A * eV_to_J * 1000
y_test = y_test / A * eV_to_J * 1000
y_val = y_val / A * eV_to_J * 1000
