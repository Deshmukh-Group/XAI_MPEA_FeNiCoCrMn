...
# print the maximum value of Y_Actual of merged_indices_df and smallest value
print("Maximum Y_Actual:", merged_indices_df['Y_Actual'].max())
print("Minimum Y_Actual:", merged_indices_df['Y_Actual'].min())
...
cbar.set_label('Bulk Modulus Calculated', fontsize=10)
