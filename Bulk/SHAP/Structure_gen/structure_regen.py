...
df_header = pd.read_csv('data100_AM1_Mn.dat', header=None, nrows=18, skip_blank_lines=False)

df_header.columns = ['c1']

# In[]
# read the data100_use1.dat for the data skipping the first 18 lines
df_data = pd.read_csv('data100_AM1_Mn.dat', header=None, skiprows=18, sep='\s+')
