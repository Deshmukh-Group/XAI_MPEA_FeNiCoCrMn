# Structure regeneration (Step 6) — elastic (bulk modulus)

`structure_regen.py` rebuilds LAMMPS structure files for the 500 SHAP-sampled
elastic structures, merging per-structure SHAP values, and feeds the
Warren–Cowley analysis (`../WarrenC/`).
...
- `data100_AM1_Mn.dat` — reference 100-oriented, 4000-atom cell (header + coordinates)
